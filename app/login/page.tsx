...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col w-[55%] relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-blue-900">
        {/* Decorative orbs */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 bg-white">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-3 mb-8 opacity-50 pointer-events-none select-none">
            <input
              type="email"
              placeholder="Alamat email"
              className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 bg-white text-slate-900 placeholder-slate-400 text-sm focus:outline-none"
              disabled
            />
            <input
              type="password"
            ...
            <p className="text-xs text-center text-slate-400">Login email akan segera tersedia</p>
          </div>

          {/* Terms */}
          <p className="text-xs text-slate-400 text-center leading-relaxed">
            Dengan masuk, Anda menyetujui{" "}
            <span className="text-blue-600 font-medium">Syarat & Ketentuan</span> serta{" "}
            <span className="text-blue-600 font-medium">Kebijakan Privasi</span> kami.
          </p>
        </div>
